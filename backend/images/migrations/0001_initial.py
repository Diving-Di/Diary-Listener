# Generated by Django 4.2.26 on 2025-12-10 11:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag_type', models.CharField(choices=[('EXIF', 'EXIF'), ('Custom', 'Custom'), ('AI', 'AI')], default='Custom', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ai_tags_json', models.TextField(blank=True, null=True)),
